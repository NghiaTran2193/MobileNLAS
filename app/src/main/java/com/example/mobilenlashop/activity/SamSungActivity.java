...
public class SamSungActivity extends AppCompatActivity {
    ...
    private ListView rcySS;
    private View footerView;

    private SamSungAdapter samSungAdapter;
    ...
    private void init(){
        toolbarSS = findViewById(R.id.toolbarSS);;
        rcySS = findViewById(R.id.rcySS);
        sanPhams = new ArrayList<>();
        samSungAdapter = new SamSungAdapter(getApplicationContext(),sanPhams);
        rcySS.setAdapter(samSungAdapter);
    ...
    private void loadMoreData(){
        rcySS.setOnItemClickListener(new AdapterView.OnItemClickListener(){
        ...
        rcySS.setOnScrollListener(new AbsListView.OnScrollListener(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response != null && response.length() != 2) {
                    rcySS.removeFooterView(footerView);
                    try {
    ...
    private void actionToolbar(){
        ...
        toolbarSS.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public class MHandler extends Handler {
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    rcySS.addFooterView(footerView);
                    break;
                case 1:
                    getData(++page);
                    isLoading = false;
